...
/* package terminal-hero-0.1.0.0 */
#ifndef VERSION_terminal_hero
#define VERSION_terminal_hero "0.1.0.0"
#endif /* VERSION_terminal_hero */
#ifndef MIN_VERSION_terminal_hero
#define MIN_VERSION_terminal_hero(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_terminal_hero */
...
#define CURRENT_COMPONENT_ID "terminal-hero-0.1.0.0-inplace-terminal-hero"
